...
import DRC20 "./DRC20";
import DIP20 "./DIP20";
import ICTokens "./ICTokens";
import ICStable "./ICStable";
...
module {
    ...
    public type CallType = { 
        ...
        #This: {
            #dp_compOpen : (_dpid: ICStable.Dpid);
            #dp_open : (_dpid: ICStable.Dpid);
            #dp_compAdd : (_dpid: ICStable.Dpid);
            #dp_add : (_dpid: ICStable.Dpid, _addColls: [(ICStable.TokenId, Nat, ICStable.CollShares)]);
            #dp_remove : (_dpid: ICStable.Dpid, _toid: Nat, _txn: ICStable.TxnRecord);
            #dp_generate : (_dpid: ICStable.Dpid, _toid: Nat, _txn: ICStable.TxnRecord);
            #dp_compClose : (_dpid: ICStable.Dpid);
            #dp_close : (_dpid: ICStable.Dpid, _toid: Nat, _txn: ICStable.TxnRecord, _closingType: ICStable.ClosingType, _sfee: Nat, _penalty: [(ICStable.TokenId, Nat)]);
        };
    };
